...
![](https://media.giphy.com/media/GWtT0aSYffclLD4iPv/giphy.gif)
...
I did feel prepared for most of the project but I could have used more practice with Routes and Link.

    If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

If I had more time I would've worked on implementing the rest of the core features.

    Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I noticed my peers had more elaborate css and filters that I can try to implement next time. I think I could've had a copy of my code saved before the presentation to avoid having bugs in my presentation.
